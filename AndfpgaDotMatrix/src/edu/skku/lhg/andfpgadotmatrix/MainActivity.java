...
import edu.skku.lhg.andfpgadotmatrix_jnidriver.fpgadotmatrix_JNI;
...
public class MainActivity extends Activity {
	...
	private fpgadotmatrix_JNI fpgadotmatrix_JNI = new fpgadotmatrix_JNI();
...
public void onCreate(Bundle savedInstanceState) {
	...
	final Button ButStart = (Button) findViewById(R.id.startButton);
		...
		if (!start) {
			...
			if (value.length() > 50) {
				...
				if (!start) {
					...
					fpgadotmatrix_JNI.DotMatrixControl(result.substring(2 * i, 2 * i + 20));
				}
				}
				}
			}
			fpgadotmatrix_JNI.DotMatrixControl("00000000000000000000");
			}
			}
		}
	}
